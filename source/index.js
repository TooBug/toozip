 ...
 * (c) Jan Jongboom, 2011
 */
var RollingBuffer = require("./lib/rollingbuffer");
var fs = require("./lib/throttlefs");
...
var Zip = function () {
	...
	var exp = (function () {
		...
		function zipFolder(dir,dest){
			...
			var fileList = readdirSyncRecursive(dir).filter(function(fileName){
				// 过滤以.开头的文件
			...
			self.addFiles(fileParam, function (err) {
